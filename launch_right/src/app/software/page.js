...
const features = [
  { icon: DevicePhoneMobileIcon, title: "Mobile Apps", desc: "Native Android apps for your business" },
  { icon: ShoppingCartIcon, title: "POS Systems", desc: "Complete retail management solutions" },
  { icon: CodeBracketIcon, title: "Custom Software", desc: "Tailored systems for your workflow" },
];
    ...
    <motion.div
      ...
      <div className={`p-6 ${isHighlighted ? "pt-10" : ""}`}>
        <div className="flex items-center gap-2 mb-3">
          <CodeBracketIcon className={`w-5 h-5 ${isHighlighted ? "text-purple-400" : colors.accent}`} />
        ...
        <ul className="space-y-2 mb-6">
          {pkg.features.map((feature, i) => (
            <li key={i} className="flex items-start gap-2 text-xs">
              <CheckIcon className={`w-4 h-4 flex-shrink-0 mt-0.5 ${isHighlighted ? "text-purple-400" : colors.accent}`} />
        ...
        <a
          ...
          className={`block w-full text-center py-3 rounded-lg font-bold text-sm transition-all ${
            isHighlighted ? "bg-purple-500 text-white hover:bg-purple-600" : "bg-navy text-white hover:bg-navy-light"
          }`}>
          Get Quote
        </a>
      </div>
      ...
      <section className="section-pad bg-surface">
        <div className="container-wide">
          <motion.div
            ...
            <h2 className="text-3xl font-bold text-navy mb-4">Choose Your Software Package</h2>
          ...
          <motion.div
            ...
            <h3 className="text-xl font-bold text-navy mb-4">Have a Unique Requirement?</h3>
            <p className="text-gray-600 mb-6">
              Tell us about your business needs and we&apos;ll build a custom solution for you.
            </p>
            <a
              href="https://wa.me/message/KTFL2G2JM3JTP1"
