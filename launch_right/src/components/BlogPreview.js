  ...
  return (
    <section className="section-pad bg-white relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 left-0 w-[400px] h-[400px] bg-gradient-to-br from-navy/2 to-transparent rounded-full blur-3xl" />
      </div>
          ...
          {latestPosts.map((post, index) => (
            <motion.article
              ...
              <Link href={`/resources/blog/${post.slug}`} className="block">
                <div className="relative mb-5 rounded-2xl overflow-hidden aspect-[16/10] bg-surface">
                  <img
                    src={post.cover}
                    alt={post.title}
                ...
                <p className="text-muted text-sm mb-4 line-clamp-2 leading-relaxed">{post.excerpt}</p>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-gold text-sm font-medium group-hover:gap-2 flex items-center gap-1 transition-all duration-200">
